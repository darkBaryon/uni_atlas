...
(function () {
  ...
  VIEWS._planSection = function (uni, prog) {
    ...
    function item(it) {
      ...
      // 英文为主、中文为辅（全站惯例）：有 label_zh 时英文名后附中文小字
      var nm = '<span class="pname">' + esc(it.label || "") +
        (it.label_zh ? ' <span class="pzh">' + esc(it.label_zh) + "</span>" : "") + "</span>";
      return '<div class="pitem' + (isCourse ? "" : " activity") + '">' +
        '<div class="pitem-main">' + codeHtml + nm +
